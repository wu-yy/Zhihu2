...
class Config(object):
    ...
    embedding_path = 'data/char_embedding.npz'  # Embedding
    train_data_path = 'data/train.npz'  # train
    labels_path = 'data/labels.json'  # labels
    test_data_path = 'data/test.npz'  # test
